...
tf.compat.v1.app.flags.DEFINE_string('image_folder', None,
                           "The path where to load the images")
tf.compat.v1.app.flags.DEFINE_integer('num_images', 30000,
                            'The number of images to be used')
tf.compat.v1.app.flags.DEFINE_integer('splits', 10,
                            "The number of splits")
tf.compat.v1.app.flags.DEFINE_integer('gpu', 0,
