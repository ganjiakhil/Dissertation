...
def sample(version, img_size,
    ...
    if version == 1:
        ...
        model_path = '/home/akhilkumar/Desktop/AttrLostGAN/pretrained/AttrLostGANv1_128x128.pth'
    elif version == 2:
        if img_size == 128:
            netG = ResnetGenerator128v2(num_classes=num_classes, output_dim=3, num_attrs=num_attrs)
            model_path = '/home/akhilkumar/Desktop/AttrLostGAN/pretrained/G_200.pth'
        elif img_size == 256:
            netG = ResnetGenerator256v2(num_classes=num_classes, output_dim=3, num_attrs=num_attrs)
            model_path = '/home/akhilkumar/Desktop/AttrLostGAN/pretrained/AttrLostGANv2_256x256.pth'
        else:
