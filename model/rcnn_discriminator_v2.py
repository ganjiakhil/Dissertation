...
class CombineDiscriminator256(nn.Module):
    def __init__(self, num_classes=81, num_attrs=None):
        super(CombineDiscriminator256, self).__init__()
        self.obD = ResnetDiscriminator256(num_classes=num_classes, input_dim=3, num_attrs=num_attrs)

    def forward(self, images, bbox, label, attrs, mask=None):
...
class CombineDiscriminator64(nn.Module):
    def __init__(self, num_classes=81, num_attrs=None):
        ...
        self.obD = ResnetDiscriminator64(num_classes=num_classes, input_dim=3, num_attrs=num_attrs)
